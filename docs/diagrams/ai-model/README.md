...
- SVG gallery markdown: `docs/diagrams/ai-model/ai-model-diagrams-svg.md`

## Number Mapping (same for PNG and SVG)
...
## File Paths
- PNG folder: `docs/diagrams/ai-model/png/`
- SVG folder: `docs/diagrams/ai-model/svg/`

Examples:
- `docs/diagrams/ai-model/png/ai-model-diagrams-png-1.png`
- `docs/diagrams/ai-model/svg/ai-model-diagrams-svg-1.svg`
