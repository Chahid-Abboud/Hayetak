...
class WorkoutPlanValidator
{
    ...
    public function validate(
        ...
        if ($name === '') $errors[] = 'workout_plan.name is required';
        if ($goal === '') $errors[] = 'workout_plan.goal is required';
        if (!is_array($days) || empty($days)) $errors[] = 'workout_plan.days must be a non-empty array';
        ...
        foreach ($days as $di => $day) {
            ...
            foreach ($dayExercises as $ei => $exRow) {
                ...
                if (!is_int($exerciseId)) {
                    if (is_numeric($exerciseId)) $exerciseId = (int) $exerciseId;
                }
                ...
                if (!is_int($sets)) {
                    if (is_numeric($sets)) $sets = (int) $sets;
                }
                ...
                if ($repsMin !== null && !is_int($repsMin)) {
                    if (is_numeric($repsMin)) $repsMin = (int) $repsMin;
                }
                if ($repsMax !== null && !is_int($repsMax)) {
                    if (is_numeric($repsMax)) $repsMax = (int) $repsMax;
                }
                ...
                if ($rest !== null && !is_int($rest)) {
                    if (is_numeric($rest)) $rest = (int) $rest;
                }
                ...
                if ($rpe !== null && !is_float($rpe) && !is_int($rpe)) {
                    if (is_numeric($rpe)) $rpe = (float) $rpe;
                }
                ...
                if (!is_int($orderIndex)) {
                    if (is_numeric($orderIndex)) $orderIndex = (int) $orderIndex;
                }
