...
class AiExportProgressPredictionData extends Command
{
    ...
    private function buildRow(
        ...
        $workouts = $this->workoutStats((int) $request->user_id, $startDate, $endDate, $horizonDays);
        ...
        $isSyntheticStrengthLabel = $isSyntheticWorkoutWindow;
        $isSyntheticRow = ($isSyntheticWeightLabel === 1 || $isSyntheticStrengthLabel === 1) ? 1 : 0;
        ...
        $row = [
            ...
            'label_strength_progress_pct' => $workouts['strength_progress_pct'],
            'has_weight_label' => $endWeight !== null ? 1 : 0,
            'has_strength_label' => $workouts['strength_progress_pct'] !== null ? 1 : 0,
    ...
    private function workoutStats(
        ...
        return [
            ...
            'strength_baseline_index' => $strength['baseline_index'],
            'strength_final_index' => $strength['final_index'],
